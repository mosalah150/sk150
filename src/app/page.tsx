            ...
            <div className="lg:col-span-7">
              ...
              <div className="border-l-2 border-brand/50 pl-4 mt-6 max-w-xl">
                <p className="text-text-muted text-base leading-relaxed sm:text-lg">
                  บันทึกก้าวแรกแห่งความภาคภูมิใจ จากเด็กชายละอ่อนสู่วิถีสุภาพบุรุษในตึกยาวประวัติศาสตร์ ร่วมเก็บรักษาเรื่องราว มิตรภาพ และความทรงจำวันแรกเริ่มของนักเรียนโรงเรียนสวนกุหลาบวิทยาลัย รุ่น 150
                </p>
              </div>
            </div>
