        ...
        <Container>
          <div className="mb-12 max-w-3xl">
            ...
            <p className="text-text-muted mt-4 text-lg leading-relaxed">
              ภาพบันทึกความทรงจำของพวกเรา สวนกุหลาบวิทยาลัย รุ่น 150 (ผู้นำแห่งอนาคต Future Leaders) ตั้งแต่วันแรกก้าวสู่ตึกยาว กิจกรรมชมพู-ฟ้า กีฬาสี จนถึงวันสำเร็จการศึกษา
            </p>
          </div>
