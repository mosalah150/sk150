        ...
        <Container>
          <div className="max-w-3xl">
            ...
            <p className="text-text-muted mt-4 text-lg leading-relaxed">
              สไลด์ย้อนเวลาดูเหตุการณ์ประวัติศาสตร์ที่สุภาพบุรุษสวนกุหลาบวิทยาลัย รุ่น 150 (ผู้นำแห่งอนาคต Future Leaders) ร่วมใจเชียร์แปลแปรอักษร กวาดแชมป์กรีฑา ติววิชาการ และสำเร็จการศึกษาร่วมกัน
            </p>
          </div>
        </Container>
      </section>
