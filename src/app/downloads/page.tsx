        ...
        <Container>
          <div className="mb-12 max-w-3xl">
            ...
            <p className="text-text-muted mt-4 text-lg leading-relaxed">
              ดาวน์โหลดหนังสือทำเนียบสุภาพบุรุษสวนกุหลาบวิทยาลัย รุ่น 150 (ผู้นำแห่งอนาคต Future Leaders) ฉบับ PDF โลโก้เวกเตอร์ตราสัญลักษณ์ชมพู-ฟ้า และภาพพื้นหลังกิจกรรมสไตล์มินิมอล
            </p>
          </div>
